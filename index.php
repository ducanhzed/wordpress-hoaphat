...
<!-- ##### Hero Area Start ##### -->
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="relative">
                <div class="bg-img" style="position : absolute; width: 100%; height : 100%; z-index : -1;">
                    <img style="position : relative; width: 100%; height : 100%;" src="<?php bloginfo('template_directory');?>/img/bg-img/hero2.jpg" alt="">
                </div>
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">

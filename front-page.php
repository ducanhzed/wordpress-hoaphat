...
<!-- ##### Hero Area Start ##### -->
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(<?php bloginfo('template_directory');?>/img/bg-img/hero1.jpg);">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(<?php bloginfo('template_directory');?>/img/bg-img/hero2.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(<?php bloginfo('template_directory');?>/img/bg-img/hero3.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="property-thumb">
                            <img src="<?php bloginfo('template_directory'); ?>/img/bg-img/feature1.jpg" alt="">
                        ...
                        <div class="property-content">
                            ...
                            <p class="location"><img src="<?php bloginfo('template_directory'); ?>/img/icons/location.png" alt="">Upper Road 3411, no.34 CA</p>
                            <p>Integer nec bibendum lacus. Suspendisse dictum enim sit amet libero malesuada.</p>
                            <div class="property-meta-data d-flex align-items-end justify-content-between">
                                <div class="new-tag">
                                    <img src="<?php bloginfo('template_directory'); ?>/img/icons/new.png" alt="">
                                </div>
                                <div class="bathroom">
                                    <img src="<?php bloginfo('template_directory'); ?>/img/icons/bathtub.png" alt="">
                                    <span>2</span>
                                </div>
                                <div class="garage">
                                    <img src="<?php bloginfo('template_directory'); ?>/img/icons/garage.png" alt="">
                                    <span>2</span>
                                </div>
                                <div class="space">
                                    <img src="<?php bloginfo('template_directory'); ?>/img/icons/space.png" alt="">
                                    <span>120 sq ft</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="200ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="<?php bloginfo('template_directory'); ?>/img/bg-img/feature2.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="<?php bloginfo('template_directory'); ?>/img/bg-img/feature3.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="400ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="<?php bloginfo('template_directory'); ?>/img/bg-img/feature4.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="<?php bloginfo('template_directory'); ?>/img/bg-img/feature5.jpg" alt="">
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="600ms">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            <img src="<?php bloginfo('template_directory'); ?>/img/bg-img/feature6.jpg" alt="">
    ...
    <section class="call-to-action-area bg-fixed bg-overlay-black" style="background-image: url(<?php bloginfo('template_directory');?>/img/bg-img/cta.jpg)">
        <div class="container h-100">
    ...
    <section class="south-editor-area d-flex align-items-center">
        ...
        <div class="editor-content-area">
            <!-- Section Heading -->
            <div class="section-heading wow fadeInUp" data-wow-delay="250ms">
                <img src="<?php bloginfo('template_directory'); ?>/img/icons/prize.png" alt="">
                <h2>jeremy Scott</h2>
                <p>Realtor</p>
            </div>
            ...
            <div class="address wow fadeInUp" data-wow-delay="750ms">
                <h6><img src="<?php bloginfo('template_directory'); ?>/img/icons/phone-call.png" alt=""> +45 677 8993000 223</h6>
                <h6><img src="<?php bloginfo('template_directory'); ?>/img/icons/envelope.png" alt=""> office@template.com</h6>
            </div>
            <div class="signature mt-50 wow fadeInUp" data-wow-delay="1000ms">
                <img src="<?php bloginfo('template_directory'); ?>/img/core-img/signature.png" alt="">
            </div>
        </div>

        <!-- Editor Thumbnail -->
        <div class="editor-thumbnail">
            <img src="<?php bloginfo('template_directory'); ?>/img/bg-img/editor.jpg" alt="">
        </div>
    </section>
    <!-- ##### Editor Area End ##### -->
</div>
